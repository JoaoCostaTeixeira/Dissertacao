...
class Active_meet extends React.Component {
    ...
    componentDidMount(){
        ...
        fetch(configRest.Create + '/getAllMeetingsActive?i=' +  cookies.get('id'))
            ...
            <header class="header-mobile d-block d-lg-none">
                ...
                <div class="container-fluid">
                    ...
                    <a href="/create" class="au-btn au-btn-icon au-btn--blue" style={{color:'white'}}> New Meeting<div></div></a>
                        <li>
                        <button class="js-arrow" href="/activemeets"><i class="fas fa-tachometer-alt"></i>Active Meetings</button>
                        </li>
                        <li>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                      <li>
                        ...
                        <li>
                            <a href="/activemeets" type="button" class="btn btn-secondary" style={{color:'white', height:"55px"}}> Active Meetings</a>
                        </li>
                        <li>
                            <br/>
                        </li>
